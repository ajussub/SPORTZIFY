...
<?php
if($rows["turf_cricket"]=="Yes")
{
	?>
    <p>Cricket Available</p>
    <?php
}
else
{
...
?><br />
<?php 
if($rows["turf_11s"]=="Yes" and $rows["turf_7s"]=="Yes" and $rows["turf_5s"]=="Yes")
{
	?>
    <p>5's, 7's, 11's Available</p>

    <?php
	
	}
	else if($rows["turf_11s"]=="Yes" and $rows["turf_7s"]=="No" and $rows["turf_5s"]=="Yes")
	{
		?>
    <p>5's, 11's Available</p>

    <?php
	}
	else if($rows["turf_11s"]=="Yes" and $rows["turf_7s"]=="Yes" and $rows["turf_5s"]=="No")
	{
		?>
    <p>7's, 11's Available</p>

    <?php
	}
	else if($rows["turf_11s"]=="Yes" and $rows["turf_7s"]=="No" and $rows["turf_5s"]=="No")
	{
		?>
    <p>11's Available</p>
	...
	else if($rows["turf_11s"]=="No" and $rows["turf_7s"]=="Yes" and $rows["turf_5s"]=="Yes")
	{
		?>
    <p>5's, 7's Available</p>

    <?php
	}
	else if($rows["turf_11s"]=="No" and $rows["turf_7s"]=="Yes" and $rows["turf_5s"]=="No")
	{
		?>
    <p> 7's Available</p>
	...
	else if($rows["turf_11s"]=="No" and $rows["turf_7s"]=="No" and $rows["turf_5s"]=="Yes")
	{
		?>
    <p>5's Available</p>
